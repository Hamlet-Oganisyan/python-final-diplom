...
class ProductInfo(models.Model):
    ...
    model = models.CharField(max_length=80, verbose_name='Модель', default=0)
    ...
    price = models.DecimalField(max_digits=9, decimal_places=2, validators=[MinValueValidator(0)],
                                verbose_name='Цена')
    price_rrc = models.DecimalField(max_digits=9, decimal_places=2, validators=[MinValueValidator(0)],
                                    verbose_name='Рекомендуемая розничная цена')
    product = models.ForeignKey(Product, verbose_name='Продукты', related_name='product_info', on_delete=models.CASCADE)
